 ...
 * 导出360浏览器的html
 */
public class _360BuildHtml extends BuildHtml{

    public _360BuildHtml(URLService urlService, FolderService folderService, User user, HttpServletResponse response) {
